...
const Main = (props) => {
    const { state, handleAddPost, handleEditTitle, handleEditPost, handleAddTitle, handleSignUp, handleSignIn, handleChange, handleRemoveTitle, handleRemovePost, acitvieAddNewTitle } = props
    return (
        <main>
            <Routes>
                <Route path='' element={
